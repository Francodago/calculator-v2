const bodyClass="bg-green-800 bg-gradient-to-br from-blue-300 bg-opacity-25";
const bdy=document.querySelector("body");
bodyClass.split(" ").forEach((cls) =>bdy.classList.add(cls));

const calcBodyClass ="max-lg rounded overflow-hidden shadow-2xl bg-yellow-300 bg-opacity-75 bg-gradient-to-tr from-purple-800 flex";
const caclbdy=document.querySelector(".calcBody");
calcBodyClass.split(" ").forEach((cls) =>caclbdy.classList.add(cls));
